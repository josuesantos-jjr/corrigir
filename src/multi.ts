...
import { checkResposta } from './service/automacoes/checkResposta multi'; 
import { loadChatSessionMap } from './Chats/multi/chatSessionMap';
import { dispararMensagens } from './disparo/disparo';
            ...
            setTimeout(() => {
              (async () => {
                ...
                if (messages.length > 0) {
                  ...
                  await checkResposta(client1, chatId, answer);
            ...
            setTimeout(() => {
              (async () => {
                ...
                if (messages.length > 0) {
                  ...
                  // Chama a função checkResposta para executar a ação
                  await checkResposta(client2, chatId, answer);
